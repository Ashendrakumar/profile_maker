              ...
              <AppCard key={index + "education" + item.title}>
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-grow pl-4 relative z-10">
                    ...
                    <p className="text-lg text-emerald-400 group-hover:text-cyan-300 transition-colors duration-300 font-medium">
                      {item.institution}
                    </p>
                    {item.details && (
                    ...
                    <div className="flex flex-col sm:flex-row text-gray-400 text-sm gap-2 sm:gap-6 mt-2">
                  ...
                  <div className="flex-shrink-0 flex items-center justify-center absolute z-10 top-0 right-0">
                    <div className="w-20 h-20 flex flex-col items-center justify-center  group-hover:from-emerald-600/20  transition-all duration-500">
                      <span className="text-2xl md:text-3xl font-bold text-emerald-300 group-hover:text-cyan-300 transition-colors duration-300">
