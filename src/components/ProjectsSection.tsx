...
const ProjectsSection = () => {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <AppCard key={index + "project" + project.projectHeading}>
                ...
                <p
                  className="text-gray-400 mb-6 flex-grow text-sm line-clamp-3 group-hover:text-gray-300 transition-colors duration-300 relative z-10"
      ...
      {/* Single drawer instance outside the loop */}
      <ProjectDrawer
